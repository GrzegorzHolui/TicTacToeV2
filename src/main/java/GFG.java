...
//        System.out.println(Arrays.deepToString(transformMapToCharArray(map)));
//
//        char board[][] = {
//                {'x', 'o', 'x'},
//                {'o', 'o', 'x'},
...
//        System.out.println(Arrays.deepToString(board));
        Move bestMove = findBestMove(transformMapToCharArray(map));
   ...
   static char[][] transformMapToCharArray(Map<PositionDto, Character> mapTicTacToe) {
